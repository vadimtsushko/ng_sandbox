...
class MeasureFilterDialogEvent {
  List<IvMasterDimension> dimensions;
  List<MeasureForFilter> measures;
}
class EventBus {
  IvEventEmitter<MeasureFilterEvent> measureFilterApplied =
      new IvEventEmitter<MeasureFilterEvent>();
  IvEventEmitter<MeasureFilterDialogEvent> showMeasureFilterDialog =
  new IvEventEmitter<MeasureFilterDialogEvent>();
